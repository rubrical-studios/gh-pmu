...
- User issues "Rollback-Previous-Step" command
...
- User: "Done-Next-Step" → Proceed to GREEN phase
...
- User: "Done-Next-Step" → Proceed to REFACTOR phase
...
### Scenario 4: Framework Command - Rollback Previous Step
